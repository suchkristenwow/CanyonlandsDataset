...
covariance_dir = "/media/kristen/easystore2/RestorebotData/May2022_final/1conmod/covariance_matrices"
...
automated_annotations = np.genfromtxt("May_results/1conmod/data.csv", delimiter=",")  # [row_tstep, true_course, measured_yaw, angular_vel]
annotated_tsteps = automated_annotations[:, 0]

# Read the GPS data
gps_results = np.genfromtxt("May_results/1conmod/results.csv", delimiter=",", skip_header=1)
...
def update(frame):
    ...
    compass_data = np.genfromtxt("May_results/1conmod/processed_compass_heading.csv", delimiter=",", skip_header=1)  # t, compassHeading
